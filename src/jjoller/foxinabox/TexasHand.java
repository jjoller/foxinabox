...
public abstract class TexasHand {
    ...
    public void playHand() {
        ...
        // deal cards
        players.forEach(dealer::dealHoleCards);
    ...
    public double outcome(String player) {
    ...
    public static class Player {
        ...
        public void setCards(EnumSet<Card> cards) {
            assert cards.size() == 2;
